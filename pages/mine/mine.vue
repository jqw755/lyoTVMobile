	...
	<view class="page">
		...
		<view class="section subscribe">
			...
			<view class="sub-input">
				<uni-icons type="link" size="16" color="#555"
		...
		<view class="menu">
		 ...
		 <view class="menu-item" @tap="goPage('settings')">
		  <view class="icon-box set">
		   <uni-icons type="gear" size="22" color="#2ecc71" />
		  </view>
			...
			<view class="img-size-options">
				<text class="img-size-btn" :class="{ active: currentCols === 'large' }" @tap="setImgSize('large')">
					...
					<view class="img-size-preview">
						<view class="preview-dot" v-for="i in 3" :key="i"
							:class="{ active: currentCols === 'large' }" />
					</view>
				</text>
				<text class="img-size-btn" :class="{ active: currentCols === 'medium' }" @tap="setImgSize('medium')">
					...
					<view class="img-size-preview">
						<view class="preview-dot" v-for="i in 4" :key="i"
							:class="{ active: currentCols === 'medium' }" />
					</view>
				</text>
				<text class="img-size-btn" :class="{ active: currentCols === 'small' }" @tap="setImgSize('small')">
					...
					<view class="img-size-preview">
						<view class="preview-dot" v-for="i in 5" :key="i"
							:class="{ active: currentCols === 'small' }" />
					</view>
				</text>
			</view>
		</view>
